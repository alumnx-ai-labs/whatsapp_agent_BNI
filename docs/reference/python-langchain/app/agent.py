"""agent.py — binds the CRM/calendar tools to a ChatAnthropic model and executes
whichever tool the model decides to call. This is the actual "LangChain agent" part:
the LLM is responsible for picking the right tool and extracting its arguments from
a natural-language instruction, rather than the app code calling the function directly.
"""
import os
